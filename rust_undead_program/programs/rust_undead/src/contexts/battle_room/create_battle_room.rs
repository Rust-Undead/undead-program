...
#[derive(Accounts)]
#[instruction(room_id: [u8; 32], warrior_name: String, selected_concepts: [u8; 5], 
...
pub fn create_battle_room(
    ...
    msg!("   Questions: 10 total from 5 topics");
